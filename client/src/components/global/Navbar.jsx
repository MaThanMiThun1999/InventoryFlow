...
//                   <button className='flex items-center text-gray-200 dark:text-gray-200'>
//                     <User className='h-5 w-5 mr-1' />
//                     Profile
//                   </button>
//                   <div className='absolute hidden group-hover:block mt-5 bg-gray-900 rounded-md shadow-lg p-2 z-10'>
//                     <Link
//                       to='/profile'
